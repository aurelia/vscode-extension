...
export default class AureliaHtmlCompletionOptionsFactory {

  public static getForAttribute(attributeName: string): Array<vscode.CompletionItem> {
  ...
  private static dataBindingAttributes = [
    'if',
    'accept',
    'accept-charset',
    'accesskey',
  ...
  private static eventBindingAttributes = [
    'keydown',
    'keypress',
    'keyup',
    'mouseenter',
  ...
  private static getBindingOptions(attributeName: string): Array<vscode.CompletionItem> {
    let elements = [];
  ...
  private static getEventOptions(attributeName: string): Array<vscode.CompletionItem> {
    let elements = [];
