...
export default class TimeElement extends MozDocElement {
  ...
  constructor() {
    ...
    this.attributes.set('datetime',
      new BindableAttribute(`This attribute indicates the time and date of the element and must be a valid date with an optional
