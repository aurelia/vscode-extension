...
export default class ScriptElement extends MozDocElement {
  ...
  constructor() {
    ...
    this.attributes.set('async',
      new BindableAttribute(`Set this Boolean attribute to indicate that the browser should, if possible, execute the 
    ...
    this.attributes.set('integrity',
      new BindableAttribute(`Contains inline metadata that a user agent can use to verify that a fetched resource has been 
      delivered free of unexpected manipulation. See Subresource Integrity.`));  
    this.attributes.set('src',
      new BindableAttribute(`This attribute specifies the URI of an external script; this can be used as an alternative to 
    ...
    this.attributes.set('type',
      new BindableAttribute(`This attribute identifies the scripting language of code embedded within a script element or 
    ...
    this.attributes.set('text',
      new BindableAttribute(`Like the textContent attribute, this attribute sets the text content of the element.  Unlike the 
    ...
    this.attributes.set('defer',
      new BindableAttribute(`This Boolean attribute is set to indicate to a browser that the script is meant to be executed 
    ...
    this.attributes.set('crossorigin',
      new BindableAttribute(`Normal script elements pass minimal information to the window.onerror for scripts which do not pass 
