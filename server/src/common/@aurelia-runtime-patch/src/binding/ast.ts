...
export class Unparser implements IVisitor<void> {
  ...
  public visitHtmlLiteral(): void { throw new Error('visitHtmlLiteral'); }
...
export class ValueConverterExpression {
  ...
  public constructor(
    ...
    public readonly name: string,
    public readonly args: readonly IsAssign[],
    public readonly nameLocation: SourceCodeLocation
  ) {
...
export class CallScopeExpression {
  ...
  public constructor(
    ...
    public readonly ancestor: number = 0,
    public readonly nameLocation: SourceCodeLocation,
    public readonly scopeLocation: SourceCodeLocation
  ) {}
...
export class ObjectLiteralExpression {
  ...
  public constructor(
    ...
    public readonly objectLocation?: SourceCodeLocation
  ) {}
